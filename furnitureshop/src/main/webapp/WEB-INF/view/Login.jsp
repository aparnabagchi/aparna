...
<div class="form-group">
<label for="password" class="col-md-4  control-label"><span class="required">*</span> Password: </label>
<div class="col-md-4 ">
...
<button type="submit" id="submit" name="submit" class="btn btn-sm btn-primary btn-block">SUBMIT</button>
</div>
</div>
<!--end Form--></form>
<!--end col block--></div>
